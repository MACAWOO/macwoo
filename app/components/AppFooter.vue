    ...
    >
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-12">
        ...
        <div class="flex flex-col gap-3">
          ...
          <!-- Social icons — below address on all sizes -->
          <div
            class="flex items-center gap-3 mt-1"
            :class="isYellowMode ? 'text-brand-dark' : 'text-white'"
          >
            <a
              href="https://www.facebook.com/share/1BscUJCSii/"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/macawooofficial"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/macawoo-official"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              class="hover:opacity-80 transition-opacity"
            ...
            <a
              href="https://youtube.com/@macawooofficial"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              class="hover:opacity-80 transition-opacity"
